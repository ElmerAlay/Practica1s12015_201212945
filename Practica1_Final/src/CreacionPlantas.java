...
public class CreacionPlantas extends JFrame implements ActionListener {
	...
	public String archivo_txtCola;
	public Cola c = new Cola();
	//public CreacionJugador cj;
	...
	public void GraficarCola(){
		...
		try{
			...
			archivo_txtCola = "digraph G {\n";
			archivo_txtCola = archivo_txtCola + "raíz;\n";
			archivo_txtCola = archivo_txtCola + "raíz -> ";
			...
			while(indice<nodos){
				...
				archivo_txtCola = archivo_txtCola + plantaTemporal.getNombre() + ";\n";
				archivo_txtCola = archivo_txtCola + plantaTemporal.getNombre() + "->";
			...
			archivo_txtCola = archivo_txtCola + plantaTemporal.getNombre() + ";\n";
			archivo_txtCola = archivo_txtCola + "}";
		
			System.out.println(archivo_txtCola);
	...
	public void CrearArchivoCola(){
		
		try{
			
			File archivo = new File("C:/textoCola.txt");
			
			FileWriter escribir = new FileWriter(archivo, true);
			
			escribir.write(archivo_txtCola);
			escribir.close();
...
public void DibujarCola(){
		...
		try{
			...
			String dotPath = "C:/Program Files (x86)/Graphviz2.39/bin/dot.exe";
			String fileInputPath = "C:/textoCola.txt";
			String fileOutputPath = "C:/imagenCola.jpg";
			String tParam = "-Tjpg";
			String tOParam = "-o";
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(btn_EditarPlanta == e.getSource()){
			...
			try{
				...
				Planta PlantaTemporal = this.listaPlanta.getPlantaAt(posicion);
				...
				PlantaTemporal.setNombre(NombrePlanta);
				PlantaTemporal.setTipoAtaque(TipoAtaque);
				PlantaTemporal.setImagenPlanta(ImagenPlanta);
				PlantaTemporal.setPuntosAtaque(PuntosAtaque);
				PlantaTemporal.setPuntosDefensa(PuntosDefensa);
		...
		if(this.btn_Graficar == e.getSource()){
