...
public class Graficas extends JFrame implements ActionListener{
	...
	public void Graficar(){
		...
		try{
			int nodos = cj.listaJugador.Length();
			int indice = 0;
			...
			while(indice<nodos){
					...
					cj.JugadorTemporal = this.cj.listaJugador.getJugadorAt(indice);
			
					archivo_txt = archivo_txt + cj.JugadorTemporal.getNombre() + ";\n";
					archivo_txt = archivo_txt + cj.JugadorTemporal.getCantidad() + ";\n";
					archivo_txt = archivo_txt + cj.JugadorTemporal.getTipo() + ";\n";
					archivo_txt = archivo_txt + cj.JugadorTemporal.getExtra() + ";\n";
			
					archivo_txt = archivo_txt + cj.JugadorTemporal.getNombre() + "->" + cj.JugadorTemporal.getCantidad() + "->" +
							cj.JugadorTemporal.getTipo() + "->" + cj.JugadorTemporal.getExtra() + ";\n";
			
					archivo_txt = archivo_txt + "raíz -> " + cj.JugadorTemporal.getNombre() + ";\n";
